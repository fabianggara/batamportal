...
interface ShoppingFormData {
    ...
    harga_rata: string; // Bisa untuk estimasi biaya
    fasilitas: string[];
    galeri: File[];
}
...
export default function BelanjaForm() {
    ...
    const subcategories = [
        ...
        { value: 'pasar-tradisional', label: 'Pasar Tradisional', icon: Store },
        { value: 'supermarket', label: 'Supermarket', icon: ShoppingCart },
        { value: 'minimarket', label: 'Minimarket', icon: ShoppingCart },
        { value: 'toko-pakaian', label: 'Toko Pakaian', icon: Shirt },
        { value: 'toko-elektronik', label: 'Toko Elektronik', icon: Laptop },
        { value: 'toko-buku', label: 'Toko Buku', icon: Book }
    ];
    ...
    const handleInputChange = (field: keyof ShoppingFormData, value: string) => {
    ...
    const validateForm = (): boolean => {
        ...
        if (!formData.subcategory) newErrors.subcategory = 'Kategori belanja wajib dipilih';
            ...
            <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
                <div className="bg-white rounded-2xl shadow-lg p-8 max-w-md w-full text-center">
                    ...
                    <p className="text-gray-600 mb-6">
                        Bisnis belanja Anda telah berhasil didaftarkan dan akan diverifikasi dalam 1-2 hari kerja.
                    </p>
                    <button 
                ...
                <div className="max-w-6xl mx-auto px-4 py-4">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h1 className="text-xl font-bold text-gray-800">Daftarkan Tempat Belanja</h1>
                                <p className="text-sm text-gray-500">Lengkapi semua informasi tempat belanja Anda</p>
                            </div>
                        </div>
            ...
            <div className="max-w-6xl mx-auto px-4 py-8">
                <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <div className="bg-white rounded-2xl shadow-sm p-6 space-y-6">
                        <h2 className="text-2xl font-bold text-gray-800 mb-6">Informasi Dasar Tempat Belanja</h2>
                        ...
                        <div className="space-y-6">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="Contoh: Mega Mall, Pasar Pagi"
                                    className={`w-full p-4 border rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-amber-500 outline-none ${
                            ...
                            <div>
                                <label className="block text-sm font-semibold text-gray-700 mb-3">
                                    Kategori Belanja <span className="text-red-500">*</span>
                                </label>
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    placeholder="Masukkan alamat lengkap toko/mall"
                                    rows={3}
                                    className={`w-full p-4 border rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-amber-500 outline-none resize-none ${
                    ...
                    <div className="bg-white rounded-2xl shadow-sm p-6">
                        ...
                        <div className="space-y-6">
                            ...
                            <div>
                                <label className="block text-sm font-semibold text-gray-700 mb-2">
                                    Deskripsi Tempat Belanja <span className="text-red-500">*</span>
                                </label>
                                <textarea
                                    value={formData.description}
                                    onChange={(e) => handleInputChange('description', e.target.value)}
                                    placeholder="Jelaskan tentang bisnis Anda, jenis produk, keunggulan, dll."
                                    rows={4}
                                    className={`w-full p-4 border rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-amber-500 outline-none resize-none ${
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-12 pr-4 py-4 border border-gray-300 rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-amber-500 outline-none"
                                    />
                                </div>
                            </div>
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className={`w-full pl-12 pr-4 py-4 border rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-amber-500 outline-none ${
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white rounded-2xl shadow-sm p-6">
                            ...
                            <p className="text-gray-600 mb-6">Pilih fasilitas yang tersedia di tempat belanja Anda</p>
                        ...
                        <div className="bg-white rounded-2xl shadow-sm p-6">
                            ...
                            <p className="text-gray-600 mb-6">Upload foto-foto menarik dari tempat usaha dan produk Anda (maksimal 10 foto)</p>
                    ...
                    <div className="flex justify-center pt-6">
                        <button
                            ...
                            className={`px-8 py-3 rounded-xl font-semibold transition-colors w-full sm:w-auto ${
                                isSubmitting ? 'bg-gray-300 text-gray-500 cursor-not-allowed' : 'bg-amber-600 text-white hover:bg-amber-700'
                            }`}
                        >
                            {isSubmitting ? 'Mendaftarkan...' : 'Daftarkan Tempat Belanja'}
                        </button>
                    </div>
                </form>
            </div>
